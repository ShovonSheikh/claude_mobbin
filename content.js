...
(function() { // <--- ADD THIS OPENING LINE
  ...
  // Check if listener is already added to avoid "duplicate listener" issues (optional but good practice)
  if (!window.hasRunMobbinScraper) {
    window.hasRunMobbinScraper = true;
